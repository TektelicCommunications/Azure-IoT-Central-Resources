...
if (port === 100) {
    decoder = [
        ...
        },
        {
            key: [0x27],
            fn: function (arg) {
                decoded_data.tick_per_input3 = decode_field(arg, 0, 15, "unsigned");
                return 2;
            }
        },
        {
            key: [0x28],
            fn: function (arg) {
                decoded_data.tick_per_input4 = decode_field(arg, 0, 15, "unsigned");
                return 2;
            }
        },
        {
        ...
        },
        {
            key: [0x38],
            fn: function (arg) {
                if(!decoded_data.hasOwnProperty('input1_threshold')) {
                    decoded_data.input1_threshold = {};
                }
        ...
        },
        {
            ...
            fn: function (arg) {
                ...
                decoded_data.input3_threshold.high = decode_field(arg, 0, 15, "unsigned") * 1000;
                decoded_data.input3_threshold.low = decode_field(arg, 16, 31, "unsigned") * 1000;
                return 4;
            }
        },
        {
            key: [0x3B],
            fn: function (arg) {
                if(!decoded_data.hasOwnProperty('input4_threshold')) {
                    decoded_data.input4_threshold = {};
                }
                decoded_data.input4_threshold.high = decode_field(arg, 0, 15, "unsigned") * 0.001;
                decoded_data.input4_threshold.low = decode_field(arg, 16, 31, "unsigned") * 0.001;
                return 4;
            }
        },
        {
            key: [0x3C],
            fn: function (arg) {
                if(!decoded_data.hasOwnProperty('moisture1_threshold')) {
                    decoded_data.moisture1_threshold = {};
                }
        ...
        },
        {
            key: [0x3D],
            fn: function (arg) {
                if(!decoded_data.hasOwnProperty('moisture2_threshold')) {
                    decoded_data.moisture2_threshold = {};
                }
        ...
        },
        {
            key: [0x3F],
            fn: function (arg) {
                if(!decoded_data.hasOwnProperty('threshold_enabled')) {
                    decoded_data.threshold_enabled = {};
                }
                ...
                decoded_data.threshold_enabled.input3 = decode_field(arg, 2, 2, "unsigned");
                decoded_data.threshold_enabled.input4 = decode_field(arg, 3, 3, "unsigned");
        ...
        },
        {
            key: [0x49],
            fn: function (arg) {
                decoded_data.upper_threshold = decode_field(arg, 0, 15, "unsigned");
                return 2;
            }
        },
        {
            key: [0x4A],
            fn: function (arg) {
                decoded_data.lower_threshold = decode_field(arg, 0, 15, "unsigned");
                return 2;
            }
        },
        {
            key: [0x4B],
            fn: function (arg) {
                decoded_data.threshold_timer = decode_field(arg, 0, 31, "unsigned") * 0.1;
                return 4;
            }
        },
        {
        ...
        },
        {
            key: [0x4D],
            fn: function (arg) {
                if(!decoded_data.hasOwnProperty('als_tx')) {
                    decoded_data.als_tx = {};
                }
