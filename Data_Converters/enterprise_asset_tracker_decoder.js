    ...
    decoder = [
        {
            ...
            fn: function (arg) {
                ...
                decoded_data.battery_status.life = 2.5 + decode_field(arg, 0, 6, "unsigned") * 0.01;
                decoded_data.battery_status.eos_alert = decode_field(arg, 7, 7, "unsigned");
                return 1;
            }
        },
        {
...
if (port === 100) {
    decoder = [
        ...
        },
        {
            key: [0x2B],
            fn: function (arg) {
                if(!decoded_data.hasOwnProperty('event_type1')) {
                    decoded_data.event_type1 = {};
                }
        ...
        },
        {
            key: [0x2C],
            fn: function (arg) {
                if(!decoded_data.hasOwnProperty('event_type2')) {
                    decoded_data.event_type2 = {};
                }
        ...
        },
        {
            ...
            fn: function (arg) {
                ...
                decoded_data.accelerometer.accelerometer_power = decode_field(arg, 7, 7, "unsigned");
                return 1;
            }
        },
        {
        ...
        },
        {
            key: [0x46],
            fn: function (arg) {
                if(!decoded_data.hasOwnProperty('accelerometer_tx')) {
                    decoded_data.accelerometer_tx = {};
                }
        ...
        },
        {
            key: [0x50],
            fn: function (arg) {
                decoded_data.number_of_devices = decode_field(arg, 0, 6, "unsigned");
                decoded_data.averaging_mode = decode_field(arg, 7, 7, "unsigned");
                return 1;
            }
        },
        {
            ...
            fn: function (arg) {
                ...
                decoded_data.ble_scan_duration.periodic = decode_field(arg, 8, 15, "unsigned");
                decoded_data.ble_scan_duration.event_based = decode_field(arg, 0, 7, "unsigned");
                return 2;
            }
        },
        {
        ...
        },
        {
            ...
            fn: function (arg) {
                ...
                decoded_data.whitelist0.oui = decode_field(arg, 0, 23, "hexstring");
                decoded_data.whitelist0.lap_start = decode_field(arg, 24, 47, "hexstring");
                decoded_data.whitelist0.lap_end = decode_field(arg, 48, 71, "hexstring");
                return 9;
            }
        },
        {
            ...
            fn: function (arg) {
                ...
                decoded_data.whitelist1.oui = decode_field(arg, 0, 23, "hexstring");
                decoded_data.whitelist1.lap_start = decode_field(arg, 24, 47, "hexstring");
                decoded_data.whitelist1.lap_end = decode_field(arg, 48, 71, "hexstring");
                return 9;
            }
        },
        {
            ...
            fn: function (arg) {
                ...
                decoded_data.whitelist2.oui = decode_field(arg, 0, 23, "hexstring");
                decoded_data.whitelist2.lap_start = decode_field(arg, 24, 47, "hexstring");
                decoded_data.whitelist2.lap_end = decode_field(arg, 48, 71, "hexstring");
                return 9;
            }
        },
        {
            ...
            fn: function (arg) {
                ...
                decoded_data.whitelist3.oui = decode_field(arg, 0, 23, "hexstring");
                decoded_data.whitelist3.lap_start = decode_field(arg, 24, 47, "hexstring");
                decoded_data.whitelist3.lap_end = decode_field(arg, 48, 71, "hexstring");
                return 9;
            }
        },
        {
    ...
    decoder = [
        {
            ...
            fn: function (arg) {
                ...
                for (var i = 0; i < arg.length * 8; i += 7 * 8) {
                    ...
                    var value = decode_field(arg, i + 6 * 8, i + 7 * 8 - 1, "signed");
                    devices += dev_id + ": " + value + ", ";
                    count += 7;
                }
                decoded_data.ble_devices = devices.substring(0, devices.length-2)
                return count;
            }
        }
    ]
